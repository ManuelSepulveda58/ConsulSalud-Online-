...
VALUES
    ...
    (5, 'Losart�n', 10000.00, 5, 1, 'Diariamente'),
    (6, 'Insulina', 15000.00, 6, 1, 'Segun indicacion medica'),
    ...
    (15, 'Ventolin', 7500.00, 7, 1, 'Segun indicacion medica'),
    ...
    (20, 'Rivotril', 12000.00, 10, 1, 'Segun indicacion medica'),
    (21, 'Zolpidem', 9000.00, 10, 1, 'Diariamente'),
    (22, 'Diazepam', 9500.00, 10, 1, 'Segun indicacion medica'),
    (23, 'Alprazolam', 10000.00, 10, 1, 'Segun indicacion medica'),
    (24, 'Alendronato', 11500.00, 8, 1, 'Semanalmente'),
    (25, 'Sildenafil', 12500.00, 8, 1, 'Segun indicacion medica'),
    (26, 'Tadalafilo', 13000.00, 8, 1, 'Segun indicacion medica'),
    (27, 'Captopril', 8000.00, 5, 1, 'Diariamente'),
    (28, 'Clonazepam', 9500.00, 10, 1, 'Segun indicacion medica'),
    (29, 'Ciclobenzaprina', 9000.00, 8, 1, 'Segun indicacion medica'),
